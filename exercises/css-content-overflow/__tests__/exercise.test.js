...
describe("css-content-overflow — структурные проверки", () => {
  it("styles/app.css задаёт overflow и text-overflow", () => {
    const css = readFileSync(path.join(exerciseDir, "styles/app.css"), "utf8");
    const errors = collectStructuralErrors([
      assertCssHasAllProperties(css, ["overflow", "text-overflow"], "styles/app.css"),
    ]);
