...
const matches = ["support@hexlet.io"];
const nonMatches = ["something here support@hexlet.io", "support@hexlet.io something here", "support@hexletzio"];

describe("regexp-anchors", () => {
