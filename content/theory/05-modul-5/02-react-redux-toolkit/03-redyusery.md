...
**Состояние** — всё, что лежит в store. При этом не все состояния одинаково полезны. Документация Redux предлагает такую классификацию:
...
Как уже говорилось в курсе [JS: React](уроках темы JS: React), структура состояния должна напоминать базу данных. Все максимально плоско и нормализованно:
