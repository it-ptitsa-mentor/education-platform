...
Тема тестирования фронтенда слишком обширна, чтобы осветить её в рамках урока. Для более глубокого погружения рекомендуем интенсив ["Тестирование фронтенда"](https://ru.hexlet.io/programs/frontend-testing-react)
