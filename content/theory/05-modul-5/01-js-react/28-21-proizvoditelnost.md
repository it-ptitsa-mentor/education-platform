...
Перед тем, как рассуждать о производительности, настоятельно рекомендуется прочитать [Optimization.guide](http://optimization.guide/).
...
[https://codepen.io/hexlet/pen/MEWemR](https://codepen.io/hexlet/pen/MEWemR)
