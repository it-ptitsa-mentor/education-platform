...
**Агрегация** — сумма, максимум, среднее и т.п.: результат строится по **всем** элементам набора, обычно в цикле.
...
Сначала подумайте над этими вопросами, а затем посмотрите код ниже:
