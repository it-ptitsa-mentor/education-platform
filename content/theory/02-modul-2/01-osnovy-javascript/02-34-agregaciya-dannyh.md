---
title: "34. Агрегация данных"
module: "Модуль 2"
topic: "Основы JavaScript"
buildin_id: 0ff6edc7-66d0-4fe1-8256-9b110bc7b6b9
---

# 34. Агрегация данных

- [Числа](https://buildin.ai/0ff6edc7-66d0-4fe1-8256-9b110bc7b6b9#3a0001e3-03f2-47fa-b3e9-e790fa900cae)

- [Строки](https://buildin.ai/0ff6edc7-66d0-4fe1-8256-9b110bc7b6b9#68ea23f6-8e41-48f7-bf65-9a8adc086157)
...
```
repeat('world', 3) // 'worldworldworld'
```
...
```
// Для вызова repeat('world', 3);
let result = ''
result = `${result}world` // world
result = `${result}world` // worldworld
result = `${result}world` // worldworldworld
```
