...
buildin_id: 12849beb-1884-4268-878c-e78598be8feb
source: platform
...
Циклы работают и со **строками** — символ по индексу `str[i]`:
...
Общая идея переворота состоит в следующем: нужно брать символы по очереди с начала строки и соединять их в обратном порядке. Звучит довольно просто. Далее проверим:
