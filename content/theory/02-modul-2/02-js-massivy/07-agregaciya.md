...
В математике существует понятие [**нейтральный элемент бинарной операции**](https://ru.wikipedia.org/wiki/%D0%9D%D0%B5%D0%B9%D1%82%D1%80%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B9_%D1%8D%D0%BB%D0%B5%D0%BC%D0%B5%D0%BD%D1%82) — это элемент, который ничего не меняет в результате его использования. Другими словами, сложение любого числа с нулем всегда дает это же число. Тогда любую сумму, например `3 + 2 + 8`, можно вычислить как `0 + 3 + 2 + 8`, чем мы и пользуемся в нашем коде.
