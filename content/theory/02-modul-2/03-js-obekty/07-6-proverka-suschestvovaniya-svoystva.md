---
title: "6. Проверка существования свойства"
module: "Модуль 2"
topic: "JS: Объекты"
...
В JavaScript есть более надежный и более правильный по смыслу способ проверить существование свойства, не сравнивая значения – это метод [Object.hasOwn()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/hasOwn). Вот как меняется функция `countFruits()`, если использовать этот метод:
