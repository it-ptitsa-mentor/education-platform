...
Наивный путь — десяток булевых флагов (`submitDisabled`, `showSpinner`, …) на каждый элемент UI.
...
Такой набор флагов описывает следствия (кнопка заблокирована), а не причину (форма в состоянии `processing`). Изменение активности кнопки, блокирование элементов, отображение спиннеров — все это следствия каких-то процессов. Умение выделить эти процессы и правильно описать в состоянии, один из краеугольных камней хорошей архитектуры.
