...
[Codepen](https://codepen.io/hexlet/pen/YzGEPGL)
...
[Codepen](https://codepen.io/hexlet/pen/WNGXbje)
...
[Codepen](https://codepen.io/hexlet/pen/gOwXbvE)

Попробуйте изменить значение свойства `column-gap` и посмотрите, как это повлияет на колонки.

## Границы между колонками

Модуль CSS Multi-column Layout позволяет задавать визуальную границу между колонками. Если вы знакомы со свойством `border`, которое устанавливает границы у блоков, то поведение вам будет знакомо. Раньше создание границ между колонками необходимо было реализовывать самостоятельно.
...
[Codepen](https://codepen.io/hexlet/pen/WNGXoqX)
...
[Codepen](https://codepen.io/hexlet/pen/eYdegew)
...
[Codepen](https://codepen.io/hexlet/pen/dypeooW)
...
[Codepen](https://codepen.io/hexlet/pen/MWjGwJY)
