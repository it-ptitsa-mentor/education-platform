...
[Codepen](https://codepen.io/hexlet/pen/JjRQvJe)
...
[Codepen](https://codepen.io/hexlet/pen/gOwNzjr)
...
[Codepen](https://codepen.io/hexlet/pen/jOMjxjZ)
...
[Codepen](https://codepen.io/hexlet/pen/YzGovPw)
...
[Codepen](https://codepen.io/hexlet/pen/PoGrapK)
...
**Интересно:** одна из задач хорошего специалиста — предусмотреть различные варианты контента внутри блока. Попробуйте в полях, где ожидается имя, выставлять длинные последовательности. Среди дизайнеров хорошей практикой является тестирование макета на «Константине Константинопольском»

---

Увеличим количество контента внутри компонента с превью сообщения.

[Codepen](https://codepen.io/hexlet/pen/dypBjbR)
...
[Codepen](https://codepen.io/hexlet/pen/LYRKBpL)
...
[Codepen](https://codepen.io/hexlet/pen/WNGqKrW)
...
[Codepen](https://codepen.io/hexlet/pen/JjRQaZx)
