...
Изображения — несомненно самый частый медиаэлемент, с которым приходится сталкиваться. Контекстное изображение, фон — всё это — изображения, которое нужно подгрузить. В зависимости от назначения изображения, оно может быть вставлено с помощью HTML или CSS.
