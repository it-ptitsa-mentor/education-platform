...
- [Детерминированность](https://buildin.ai/5a7ee88c-d83f-490a-bed8-048dbccc198d#3b964345-59d7-49fb-b454-2ef34d766d55)

- [Побочные эффекты (side effects)](https://buildin.ai/5a7ee88c-d83f-490a-bed8-048dbccc198d#a3921aa7-4c81-445e-8f89-7bbd55819481)

- [Чистые функции](https://buildin.ai/5a7ee88c-d83f-490a-bed8-048dbccc198d#a4c8ea25-9df5-4338-9b9f-127a728d65b8)
...
Вызов `console.log('Boom - Big Bang')` выполнил два действия:

- Вывел сообщение Boom* - Big Bang* в терминал (или консоль браузера, в зависимости от среды выполнения)
...
1. Записывает результат работы программы в новый файл.
