...
Иногда нужен не любой `string`, а фиксированный набор значений — статусы, коды справочников. Пример статусов заказа:
...
При типе `string` компилятор не ловит опечатки и лишние значения:
