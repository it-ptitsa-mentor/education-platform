...
В TypeScript используется несколько способов типизировать функции, которые передаются как параметры. В этом разделе мы научитесь работать с ними.
...
Разберём ещё несколько примеров для закрепления:
