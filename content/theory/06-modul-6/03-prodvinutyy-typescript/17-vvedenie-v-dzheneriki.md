...
buildin_id: c323d257-2553-42f6-849a-3b4416c5ca95
source: platform
...
Статическая типизация ловит ошибки типов, но иногда требует более сложных конструкций — начнём с дженериков.
...
В JavaScript `merge` сразу работает с любыми массивами без объявления типов.
...
**Дженерики** у функций — одна реализация для разных типов данных (обобщённые функции).
...
first([]) // null
first([3, 2]) // 3
first(['code-basics', 'het']) // code-basics
```
