...
Общее поведение для семейства классов задают абстрактные классы — разберём синтаксис и применение.

Абстрактные классы хоть и не могут быть созданы напрямую, но они могут быть наследованы. Еще они могут указать явно, какой метод должен быть реализован в наследниках:
